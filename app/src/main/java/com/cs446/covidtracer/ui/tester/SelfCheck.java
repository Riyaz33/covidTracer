...
public class SelfCheck {
    ...
    public String selfTestReport(){
        ...
        if(hasSevereSymptons) {
            report = report + " You responded YES to having severe symptoms (tough time breathing, chest pain, confusion, or losing consciousness)." +
                    " Please visit a healthcare provider ASAP. \n\n";
            return report;
        } else {
            report  = report + " You responded NO to having severe symptoms (tough time breathing, chest pain, confusion, or losing consciousness).\n\n";
        }

        if(hasCovidSymptoms) {
            report = report + " You responded YES to having known COVID symptoms (cough, pink eye, fever, chills, shortness of breath, sore throat)." +
            ...
            report  = report + " You responded NO to having known COVID symptoms (cough, pink eye, fever, chills, shortness of breath, sore throat).\n\n";
        }

        if(age > 0) {
            report = report + " You entered age: " + age + ".\n\n";
            if(atRiskAge){
                report = " Your age puts you at high-risk. Please self-isolate and practice social distancing as much as possible.\n\n";
            }
        }

        if(isInAtRiskGroup){
            report = report + " You responded YES to being in an at-risk group." +
                    " We recommend you to get an official COVID-19 test. Assessment centers can be found here: https://covid-19.ontario.ca/assessment-centre-locations/." +
                    "Please practice social distancing as much as possible.\n ";
            return report;
        } else {
            report  = report + " You responded NO to being in an at-risk group.\n";
        }
